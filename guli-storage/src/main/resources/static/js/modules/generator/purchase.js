$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'purchase/list',
        datatype: "json",
        colModel: [			
			{ label: 'id', name: 'id', index: 'id', width: 50, key: true },
			{ label: '采购人id', name: 'assigneeId', index: 'assignee_id', width: 80 }, 			
			{ label: '采购人名', name: 'assigneeName', index: 'assignee_name', width: 80 }, 			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.purchase.id == null ? "purchase/save" : "purchase/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(id){
			$.get(baseURL + "purchase/info/"+id, function(r){
                vm.purchase = r.purchase;
            });
		},
